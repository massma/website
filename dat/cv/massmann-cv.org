...
# TODO: change to use latex to export all presentations and pubs? just
# not sure if it is worth the extra headache or not.

# #+LaTeX_HEADER: \input{biblatex-config.tex}
# #+LaTeX_HEADER: \addbibresource{massmann-papers.bib}
