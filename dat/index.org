...
*** Teaching
    ...
    towards a collaboration between students and teachers. Ideally
    there is a two way dialog and everyone works together to improve
    the learning process (and learn).  If thoughtfully deployed, I
    think technology can help with this.
...
*** Resources (mostly for fellow students)
    ...
    The origins of each of these pages are discussions and
    emails. After rehashing the same content multiple times I decided
    to just put it on the web for easy linking, and in case it is
    useful to the public.

    - [[file:writing.html][Writing]]
    - [[file:grad-school.html][Tips for Ph.D. students]]
    - [[file:courses.html][Recommended courses at Columbia]]
